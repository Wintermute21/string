...
void test_less_than_sizes_equal();
void test_less_than_first_shorter_true();
void test_less_than_first_shorter_false();
void test_less_than_first_longer_true();
void test_less_than_first_longer_false();
void test_less_than_first_empty();
void test_less_than_second_empty();
void test_less_than_both_empty();
void test_less_than_substring_first_longer();
void test_less_than_substring_first_shorter();

int main()
{
    test_less_than_sizes_equal();
    test_less_than_first_shorter_true();
    test_less_than_first_shorter_false();
    test_less_than_first_longer_true();
    test_less_than_first_longer_false();
    test_less_than_first_empty();
    test_less_than_second_empty();
    test_less_than_both_empty();
    test_less_than_substring_first_longer();
    test_less_than_substring_first_shorter();
}

...
void test_not_equal_sizes_equal();
void test_not_equal_first_shorter_true();
void test_not_equal_first_shorter_false();
void test_not_equal_first_longer_true();
void test_not_equal_first_longer_false();
void test_not_equal_first_empty();
void test_not_equal_second_empty();
void test_not_equal_both_empty();
void test_not_equal_substring_first_longer();
void test_not_equal_substring_first_shorter();

int main()
{
    test_not_equal_sizes_equal();
    test_not_equal_first_shorter_true();
    test_not_equal_first_shorter_false();
    test_not_equal_first_longer_true();
    test_not_equal_first_longer_false();
    test_not_equal_first_empty();
    test_not_equal_second_empty();
    test_not_equal_both_empty();
    test_not_equal_substring_first_longer();
    test_not_equal_substring_first_shorter();
}
